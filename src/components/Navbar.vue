<template>
  ...
  <header class="grid mb-64 md:mb-0 md:h-14 grid-cols-3 grid-rows-1 items-center text-base text-white transition-colors delay-150 ease-in-out hover:bg-amber-50 hover:text-black">
