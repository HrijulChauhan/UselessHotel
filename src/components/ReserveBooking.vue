    ...
    <section class="m-auto flex w-3/4">
      ...
      <form @submit.prevent class="md:pl-10">
        ...
        <span>
          ...
          <input type="text" placeholder="John Doe" class="mt-1 block w-80 rounded-sm border-0 py-2 pl-3 text-sm shadow-sm outline-none ring-1 ring-inset ring-slate-200 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-indigo-600" />
        </span>
        ...
        <span>
          ...
          <input type="text" placeholder="john.doe@gmail.com" class="mt-1 block w-80 rounded-sm border-0 py-2 pl-3 text-sm shadow-sm outline-none ring-1 ring-inset ring-slate-200 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-indigo-600" />
        </span>

        <!-- Enter location -->
        <span>
          <label for="Location" class="mt-6 block text-sm font-medium leading-6 text-gray-900">Select Location</label>

          <select name="" id="" class="mt-1 block w-80 rounded-sm border-0 py-2 pl-2 text-sm text-gray-400 shadow-sm outline-none ring-1 ring-inset ring-slate-200 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-indigo-600">
            <option value="">New York, USA</option>
            <option value="">Turkey, Istanbul</option>
        ...
        <button class="discover mt-6 w-32 py-2 text-sm">Confirm</button>
      </form>
    </section>
  </body>
</template>
